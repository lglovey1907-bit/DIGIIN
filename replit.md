...
- **Inspector Signature Table**: Dynamic formatting at document end - single inspector displays name and designation as stacked paragraphs (right-aligned), multiple inspectors use borderless table with Name/Designation columns and positioning logic: 1st inspector right-aligned, 2nd inspector center-aligned, 3rd+ inspectors left-aligned, no heading, fixed to properly pass inspector data from database to document converter
